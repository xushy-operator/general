...
type MyObjectSpec struct {
	...
	// Foo is an example field of MyObject. Edit myobject_types.go to remove/update
...
type MyObjectList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MyObject `json:"items"`
}

func init() {
	SchemeBuilder.Register(&MyObject{}, &MyObjectList{})
}
